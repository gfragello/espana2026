...
> **Presupuesto:** Alto  
> **Región:** Andalucía  
> **Aerolínea:** Air Europa (UX) — despacha equipaje a destino final  
> **Bases de hotel:** Sevilla (6 noches) + Málaga (4 noches)  
> **Auto de alquiler:** Sixt, 17/09 al 23/09

---

## Resumen del itinerario

| Día | Fecha | Día semana | Plan | Alojamiento | Detalle |
|-----|-------|------------|------|-------------|---------|
| 1 | 12/09 | Sábado | ✈️ Vuelo MVD → MAD (nocturno) | Avión | [→ Sevilla 1](sevilla-1.md#día-1--sáb-1209--vuelo-mvd--madrid) |
...
## ✈️ VUELOS — Air Europa (UX)

### Ida: Montevideo → Sevilla (12-13 sept)

| Tramo | Vuelo | Salida | Llegada | Terminal |
|-------|-------|--------|---------|----------|
| **MVD → MAD** | Air Europa | 🕐 12/09 — 12:20 (hora MVD) | 🕐 13/09 — 05:10 (hora Madrid) | Llega **T1** Madrid |
| **MAD → SVQ** | Air Europa | 🕐 13/09 — 09:20 (hora Madrid) | 🕐 13/09 — 10:30 (hora Sevilla) | Sale **T2** Madrid |
...
| Tramo | Vuelo | Salida | Llegada | Terminal |
|-------|-------|--------|---------|----------|
| **SVQ → MAD** | Air Europa | 🕐 23/09 — ~21:00 (hora Sevilla) | 🕐 23/09 — 22:20 (hora Madrid) | Llega **T2** Madrid |
| **MAD → MVD** | Air Europa | 🕐 23/09 — 23:55 (hora Madrid) | 🕐 24/09 — 07:35 (hora MVD) | Sale **T1** Madrid |

> ⚠️ **Conexión ajustada en Madrid: T2 → T1.** Solo **1h 35min** de conexión. Equipaje despachado a destino final (MVD). No hay tiempo para sala VIP.
...
Precio SP98 en España (sept 2026): ~€1,70-1,80/L.
...
## ✅ Reservas importantes (hacer con antelación)
...
- [x] 🚢 **Crucero Guadalquivir 15:00 (para 15/09)** — ✅ Comprado · $41,72 USD total (2 pax) · GetYourGuide · Tickets en la app
...
- **Clima en septiembre:** Caluroso en Andalucía (25-35°C). Llevar protección solar, ropa ligera y calzado cómodo.
- **Horarios españoles:** Almuerzo sobre las 14:00-15:30, cena a partir de las 21:00.
- **Siesta:** Muchas tiendas cierran entre 14:00 y 17:00.
- **Propinas:** No es obligatorio, pero se deja ~5-10% en restaurantes de mantel.
- **Combustible:** El Peugeot 208 usa gasolina **SP98 (Sin Plomo 98)**. Buscar gasolineras Repsol, Cepsa o BP. Evitar las low-cost (pueden no tener SP98).
- **Peajes:** La AP-4 (Sevilla-Cádiz) tiene peaje. La A-92 (Sevilla-Málaga) y A-45 son libres.
- **Estacionamiento:** En centros históricos es difícil. Usar parkings públicos subterráneos (~€15-20/día).
- **Diferencia horaria:** España = Uruguay + 5 horas (en septiembre).
- **Moneda:** Euro (€). Tarjetas aceptadas en casi todas partes.

---

## Apps y recursos útiles

- **Renfe** — billetes AVE y trenes
- **Google Maps / Waze** — navegación por carretera
- **TheFork / El Tenedor** — reservas en restaurantes
