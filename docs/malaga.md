...
## Día 6 — Jue 17/09 · 🚗 Recogida del auto · Sevilla → Córdoba → Málaga

- 🏨 Check-out [**Meliá Sevilla**](https://www.google.com/maps/place/Meliá+Sevilla,+Dr.+Pedro+de+Castro,+1,+41004+Sevilla)
- 🕐 9:30 — Recogida del coche en 📍 [**Sixt Estación Santa Justa**](https://www.google.com/maps/search/Sixt+Estación+Santa+Justa+Sevilla)
  - [Ruta hotel → Santa Justa](https://www.google.com/maps/dir/Meliá+Sevilla/Estación+de+Sevilla-Santa+Justa) (~15 min taxi)
- 🕐 10:00 — Salida hacia Córdoba por la A-4/E-5
...
> 💡 *Día largo de viaje con visita completa a Córdoba. Cena tranquila en Málaga y descanso temprano para preparar la excursión a Granada del día siguiente.*

---

### 🚗 Ruta Sevilla → Córdoba
...
### 🅿️ ~12:00 — Parking la Mezquita de Córdoba

📍 [**Parking la Mezquita**](https://www.google.com/maps/search/Parking+la+Mezquita+Córdoba) — C/ Cairuán, 1, 14004 Córdoba.
...
| Detalle | Info |
|---------|------|
| **Qué es** | Patrimonio UNESCO. Antigua mezquita con catedral renacentista en su interior. Bosque de columnas y arcos bicolores icónicos |
...
1. **Patio de los Naranjos** — acceso libre, fuentes y naranjos (entrada por la Puerta del Perdón)
2. **Bosque de columnas** — 856 columnas con arcos de herradura bicolores (rojo y blanco)
3. **Mihrab** — joya del arte islámico, mosaicos bizantinos dorados
4. **Capilla Mayor y coro** — catedral renacentista insertada en la mezquita
5. **Capilla de Villaviciosa** — transición entre estilos islámico y cristiano
...
| Detalle | Info |
|---------|------|
| **Qué es** | Antiguo barrio judío, Patrimonio UNESCO. Callejuelas blancas estrechas con flores |
| **Precio** | Gratis (paseo libre) |
| **Duración** | ~1h |

#### Qué ver

- [**Calleja de las Flores**](https://www.google.com/maps/place/Calleja+de+las+Flores,+Córdoba) — la calle más fotografiada de Córdoba, con macetas de geranios y vista a la torre de la Mezquita
- [**Sinagoga de Córdoba**](https://www.google.com/maps/place/Sinagoga+de+Córdoba) — una de las tres sinagogas medievales conservadas en España (entrada gratuita para ciudadanos UE)
- **Plaza de Maimónides** — estatua del filósofo cordobés
- **Zoco Municipal** — patio con talleres artesanales y tiendas de souvenirs
- Callejuelas con patios floridos visibles desde la calle
...
Zona recomendada: calles de la Judería y alrededores de la Mezquita.

| Sugerencia | Tipo | Nota |
|------------|------|------|
| [**Taberna Salinas**](https://www.google.com/maps/search/Taberna+Salinas+Córdoba) | Taberna tradicional desde 1879 | Salmorejo, flamenquín, rabo de toro |
| [**Bodegas Mezquita (Céspedes)**](https://www.google.com/maps/search/Bodegas+Mezquita+Córdoba) | Cocina cordobesa junto a la Mezquita | Berenjenas con miel, flamenquín |
| [**Casa Pepe de la Judería**](https://www.google.com/maps/search/Casa+Pepe+de+la+Judería+Córdoba) | Restaurante con patio andaluz | Rabo de toro, salmorejo |

> 💡 *Platos típicos cordobeses: salmorejo, flamenquín, berenjenas con miel, rabo de toro. Todos aptos para Pasajero 2.*
...
| Detalle | Info |
|---------|------|
| **Qué es** | Fortaleza medieval, residencia de los Reyes Católicos. Torres, patios y amplios jardines con fuentes |
| **Horario (17/09)** | Martes a viernes: 8:15–20:00 (a partir del 16/09 horario de invierno) |
| **Duración** | ~1h 30min (incluye jardines) |
...
1. **Torre de los Leones** — subir para vistas panorámicas de Córdoba
2. **Salón de los Mosaicos** — mosaicos romanos del siglo II-III
3. **Patio Mudéjar** — arquitectura islámica reconvertida
4. **Jardines del Alcázar** — extensos jardines con estanques, fuentes y setos recortados (lo mejor del Alcázar)
5. **Torre del Homenaje** — vistas al Puente Romano y al río Guadalquivir

> 💡 *Los jardines son espectaculares y merecen tiempo. Buena oportunidad para sentarse y descansar los pies antes de continuar.*
...
| Detalle | Info |
|---------|------|
| **Qué es** | Puerta monumental del siglo XVI, antiguo acceso a la ciudad desde el Puente Romano |
| **Precio** | Gratis (exterior) |
| **Duración** | ~15 min |

> 💡 *Se encuentra entre la Mezquita y el Puente Romano. Buen punto para fotos con el puente y el río de fondo.*
...
| Detalle | Info |
|---------|------|
| **Qué es** | Puente de origen romano (siglo I a.C.), 16 arcos, 331 metros. Reconstruido varias veces. Peatonal desde 2004 |
| **Precio** | Gratis |
| **Duración** | ~30 min (cruzar, fotos y volver) |
...
Cena tranquila cerca del hotel tras el día de viaje.

- *Sugerencia:* tapas ligeras en el centro o en el propio hotel
- 🚫🦐 *Recordar restricción alimentaria de Pasajero 2*

### 😴 ~22:45 — A dormir

> 💡 *Descanso temprano. Al día siguiente (18/09) — paseo a pie por los ocho puntos imprescindibles de Málaga. Inicio tranquilo a las 10:00, día sin auto.*
...
## Día 7 — Vie 18/09 · � Málaga a pie — 8 puntos imprescindibles

> 🚶 Jornada completa caminando por Málaga. Sin auto. Inicio 10:00, finalización ~20:30.  
> 📍 Ruta optimizada: empezar por lo alto (Gibralfaro) y descender hacia el mar.
...
| 13:00 | 15' | 🏛️ **③ Teatro Romano** — vista exterior y centro de interpretación |
| 13:15 | 15' | 🚶 Paseo hasta la Catedral (~8 min) |
| 13:30 | 20' | ⛪ **④ Catedral de Málaga** — exterior, "La Manquita" |
| 13:50 | 10' | 🚶 Paseo hasta Mercado de Atarazanas (~5 min) |
| 14:00 | 1h 30' | 🏪 **⑤ Mercado Central de Atarazanas** — recorrido y **almuerzo** |
| 15:30 | 10' | 🚶 Paseo hasta Calle Larios |
| 15:40 | 50' | 🛍️ **⑥ Calle Larios → Plaza de la Constitución** — paseo peatonal |
| 16:30 | 30' | ☕ Merienda / helado |
| 17:00 | 10' | 🚶 Paseo hasta el Ayuntamiento |
| 17:10 | 1h | 🏛️ **⑦ Ayuntamiento y Parque de Málaga** — jardines, paseo |
| 18:10 | 20' | 🚶 Paseo por [Muelle Uno](https://www.google.com/maps/place/Muelle+Uno,+Málaga) (zona portuaria) |
| 18:30 | 1h | 🏖️ **⑧ La Malagueta** — paseo marítimo y playa |
| 19:30 | 1h | 🍹 Chiringuito o terraza frente al mar — atardecer ~20:00 |
| ~20:30 | — | 🍽️ Cena |

> 💡 *Ruta optimizada para minimizar idas y vueltas: empezamos arriba (Gibralfaro), bajamos por la Alcazaba, cruzamos el centro hacia el oeste (Catedral, Mercado) y volvemos al este por la peatonal (Larios) hasta terminar en la playa. Total caminando: ~6-7 km.*

---

### 🏰 10:15 — ① Castillo Gibralfaro (1h 15min)

📍 [**Castillo de Gibralfaro**](https://www.google.com/maps/place/Castillo+de+Gibralfaro,+Málaga) — Monte Gibralfaro.

| Detalle | Info |
|---------|------|
| **Qué es** | Fortaleza fenicia-nazarí del siglo XIV sobre el monte Gibralfaro. Las mejores vistas panorámicas de Málaga, el puerto y la costa |
...
- **Taxi** desde el hotel (~€8-10, 10 min) — la opción más cómoda
- **Bus línea 35** desde Paseo del Parque (~€1,40/pax, cada 20-30 min)
- No recomendamos subir a pie (cuesta empinada, >20 min) para reservar energía para el resto del día

#### Qué ver

- **Murallas y torres** — recorrido perimetral por las almenas con vistas 360°
- **Mirador norte** — vistas a la ciudad, la Catedral y las montañas
- **Mirador sur** — vistas al puerto, la plaza de toros de La Malagueta y el Mediterráneo
- **Centro de interpretación** — historia del castillo y la ciudad

> 💡 *Desde Gibralfaro se accede directamente a la Alcazaba por un camino amurallado descendente (~15 min, cuesta abajo). No es necesario salir y volver a entrar.*

---

### 🏛️ 11:45 — ② Alcazaba de Málaga (1h 15min)

📍 [**Alcazaba de Málaga**](https://www.google.com/maps/place/Alcazaba+de+Málaga) — C/ Alcazabilla.

| Detalle | Info |
|---------|------|
| **Qué es** | Palacio-fortaleza árabe del siglo XI, la mejor conservada de España. Jardines, patios con agua y arcos de herradura |
| **Horario (sept)** | 9:00–20:00 |
| **Duración** | ~1h 15min |
...
1. **Puerta de los Arcos** — entrada monumental
2. **Jardines y terrazas** — vegetación mediterránea, buganvillas
3. **Palacio Nazarí** — patios con agua, arcos y azulejos (una mini-Alhambra)
4. **Torre del Homenaje** — vistas al puerto y al Teatro Romano
5. **Salida por la entrada principal** — se sale directamente al Teatro Romano

---

### 🏛️ 13:00 — ③ Teatro Romano (15 min)

📍 [**Teatro Romano de Málaga**](https://www.google.com/maps/place/Teatro+Romano+de+Málaga) — C/ Alcazabilla, al pie de la Alcazaba.

| Detalle | Info |
|---------|------|
| **Qué es** | Teatro del siglo I a.C. (época de Augusto), descubierto en 1951. El monumento más antiguo de Málaga |
| **Precio** | **Gratis** ✅ |
| **Centro de interpretación** | Gratis, pequeño museo junto al teatro |
| **Duración** | ~15 min |

> 💡 *Se ve perfectamente desde la calle. El centro de interpretación es pequeño pero interesante (acceso rápido, ~10 min).*

---

### ⛪ 13:30 — ④ Catedral de Málaga — exterior (20 min)

📍 [**Catedral de la Encarnación**](https://www.google.com/maps/place/Catedral+de+Málaga) — C/ Molina Lario.

| Detalle | Info |
|---------|------|
| **Qué es** | Catedral renacentista-barroca del siglo XVI. Apodada **"La Manquita"** porque la torre sur nunca se terminó |
| **Precio** | Gratis (exterior) |
| **Duración** | ~20 min |

#### Qué ver desde el exterior

- **Fachada principal** (Plaza del Obispo) — la mejor perspectiva para fotos
- **Torre norte** (84 m) — la única terminada
- **Torre sur inacabada** — el origen del apodo "La Manquita"
- **Plaza del Obispo** — buen punto para sentarse y admirar la fachada

> 🚶 *Desde la Catedral, el Mercado de Atarazanas está a ~5 min caminando por C/ Santa María.*

---

### 🏪 14:00 — ⑤ Mercado Central de Atarazanas — almuerzo (1h 30min)

📍 [**Mercado Central de Atarazanas**](https://www.google.com/maps/place/Mercado+Central+de+Atarazanas,+Málaga) — C/ Atarazanas, 10.

| Detalle | Info |
|---------|------|
| **Qué es** | Mercado municipal de 1879 en un edificio de hierro con portada nazarí original del siglo XIV. El corazón gastronómico de Málaga |
| **Horario** | Lunes a sábado 8:00–15:00 |
| **Precio** | Entrada gratis; comida según consumo |
| **Duración** | ~1h 30min (recorrido + almuerzo) |

> ⚠️ **El mercado cierra a las 15:00.** Llegando a las 14:00 hay tiempo justo para recorrer y almorzar cómodamente. No demorarse en la Catedral.

#### 🍽️ ¿Almorzar aquí? — ✅ Absolutamente recomendado

El Mercado de Atarazanas es **uno de los mejores lugares de Málaga para almorzar**. Los bares y puestos del interior sirven producto fresco del día a precios razonables, en un ambiente auténtico y local.

| Qué pedir | Dónde | Nota |
|-----------|-------|------|
| Tapas de producto fresco, jamón ibérico, quesos | Bares del interior (hay varios) | Sentarse en cualquier barra |
| Aceitunas aliñadas, banderillas, encurtidos | Puestos de encurtidos | Para picar mientras se recorre |
| Fruta de temporada (higos, uvas, melón) | Fruterías | Postre perfecto |

> 🚫🦐 *Pasajero 2: los bares de pescaíto frito son muy populares aquí, pero hay excelentes opciones de carne — jamón ibérico, lomo, pinchos de pollo, quesos curados. Pedir en cualquier barra.*

> 💡 *Presupuesto almuerzo: ~€15-25/pax entre tapas, bebida y fruta. Ambiente 100% local.*

---

### 🛍️ 15:40 — ⑥ Calle Larios → Plaza de la Constitución (50 min)

📍 [**Calle Marqués de Larios**](https://www.google.com/maps/place/Calle+Marqués+de+Larios,+Málaga) — la arteria peatonal principal de Málaga.

| Detalle | Info |
|---------|------|
| **Qué es** | Calle peatonal más elegante de Málaga (desde 2002). Edificios del siglo XIX, tiendas, cafés |
| **Longitud** | ~350 m (desde Plaza de la Marina hasta Plaza de la Constitución) |
| **Precio** | Gratis |
| **Duración** | ~50 min (con paradas) |

#### Recorrido

1. **Calle Larios** — paseo por la peatonal, edificios con balcones simétricos
2. **Plaza de la Constitución** — la plaza principal de Málaga desde el siglo XV, fuente genovesa
3. **Calles adyacentes** — callejuelas del casco histórico con tiendas de artesanía

#### ☕ 16:30 — Merienda

Parada para café, helado o refresco en las terrazas de la Plaza de la Constitución.

> 💡 *Heladería recomendada: [**Casa Mira**](https://www.google.com/maps/search/Casa+Mira+Málaga+Calle+Larios) (desde 1890, en Calle Larios) — famosa por sus helados artesanales y turrón.*

---

### 🏛️ 17:10 — ⑦ Ayuntamiento y Parque de Málaga (1h)

📍 [**Ayuntamiento de Málaga**](https://www.google.com/maps/place/Ayuntamiento+de+Málaga) — Av. de Cervantes, 4.

| Detalle | Info |
|---------|------|
| **Ayuntamiento** | Edificio neobarroco de principios del siglo XX. Fachada elegante con jardines delanteros |
| **Parque de Málaga** | Paseo ajardinado de ~1 km entre el centro y el puerto. Árboles tropicales, fuentes, esculturas |
| **Precio** | Gratis |
| **Duración** | ~1h |

#### Recorrido

1. **Ayuntamiento** — fachada y [Jardines de Pedro Luis Alonso](https://www.google.com/maps/search/Jardines+Pedro+Luis+Alonso+Málaga) (jardín formal, rosaleda)
2. **Paseo del Parque** — bulevar con árboles tropicales centenarios (ficus, palmeras, jacarandás)
3. **Fuente de las Tres Gracias** y esculturas
4. Continuar hacia el puerto y [**Muelle Uno**](https://www.google.com/maps/place/Muelle+Uno,+Málaga) — zona comercial del puerto con tiendas y restaurantes

---

### 🏖️ 18:30 — ⑧ La Malagueta (2h)

📍 [**Playa de la Malagueta**](https://www.google.com/maps/place/Playa+de+la+Malagueta,+Málaga) — paseo marítimo al este del puerto.

| Detalle | Info |
|---------|------|
| **Qué es** | Playa urbana principal de Málaga. Paseo marítimo con chiringuitos, vistas al puerto |
| **Precio** | Gratis |
| **Atardecer** | ~20:00–20:15 en septiembre |

#### Qué hacer

- 🚶 **Paseo marítimo** — caminar por el paseo de La Malagueta con vistas al Mediterráneo
- 📸 **Letras "MALAGUETA"** — escultura icónica para foto
- 🍹 **Chiringuito o terraza** — sentarse a tomar una copa viendo el atardecer
- 🌅 **Atardecer** — el sol se pone ~20:00 sobre el puerto, luz espectacular

> 💡 *Punto perfecto para cerrar el día con calma. Los chiringuitos sirven bebidas y tapas hasta la noche. Desde aquí se va caminando a cenar (~10-15 min al centro).*

---

### 🍽️ ~20:30 — Cena en Málaga

> 🚫🦐 *Recordar: Pasajero 2 no come frutos del mar.*

Opciones cerca de La Malagueta o en el centro (10-15 min caminando):

| Restaurante | Tipo | Precio aprox. | Nota |
|-------------|------|---------------|------|
| [**El Pimpi**](https://www.google.com/maps/search/El+Pimpi+Málaga) | Bodega-restaurante emblemática | €25-35/pax | Institución malagueña, terraza con vistas a la Alcazaba. Probar el vino dulce de Málaga |
| [**Uvedoble Taberna**](https://www.google.com/maps/search/Uvedoble+Taberna+Málaga) | Tapas y raciones modernas | €25-35/pax | Cocina andaluza moderna, ambiente acogedor |
| [**KGB Málaga**](https://www.google.com/maps/search/KGB+Málaga+restaurante) | Gastrobar creativo | €30-40/pax | Tapas creativas, excelente relación calidad-precio |

> 🎯 **Recomendación:** [**El Pimpi**](https://www.google.com/maps/search/El+Pimpi+Málaga) — el bar más emblemático de Málaga, en una bodega del siglo XVIII frente al Teatro Romano. Imprescindible probar el **vino dulce de Málaga** (Virgen). Terraza con vistas a la Alcazaba iluminada.
...
| Detalle | Info |
|---------|------|
| **Qué es** | Patrimonio UNESCO. Residencia de verano de los reyes nazaríes (siglos XIII-XIV). Exuberantes jardines, fuentes, patios y huertas con vistas a la Alhambra y a Sierra Nevada |
| **Incluido en** | Entrada general de la Alhambra |
| **Duración** | ~1h 15min (paso sosegado) |

#### Recorrido sugerido (~1h 15min)

1. **Jardines Nuevos (Jardines Bajos)** — amplios jardines del siglo XX con setos recortados, cipreses y rosales. Paseo tranquilo de entrada
2. **Escalera del Agua** — icónica escalera con agua corriendo por los pasamanos de piedra
3. **Patio de la Acequia** — el corazón del Generalife. Canal central con surtidores de agua flanqueado por jardines y un pabellón al fondo. El lugar más fotografiado
...
| Detalle | Info |
|---------|------|
| **Qué es** | Fortaleza militar del siglo XI, la parte más antigua de la Alhambra. Torres defensivas y vistas panorámicas de Granada |
| **Incluido en** | Entrada general de la Alhambra |
| **Duración** | ~30 min |

#### Qué ver

- **Torre de la Vela** — la torre más alta. Subir para vistas 360° de Granada, la Vega, Sierra Nevada y el Albaicín. Aquí se izó la bandera cristiana en 1492
- **Torre del Homenaje** — la torre del homenaje, visible desde el patio
- **Barrio castrense** — restos del barrio de los soldados de élite (cocinas, hammam, aljibe)
- **Plaza de Armas** — patio central de la fortaleza
...
### 🍽️ 16:20 — Almuerzo tardío / tapas en Granada (50 min)

> 🚫🦐 *Recordar: Pasajero 2 no come frutos del mar.*

📍 Zona recomendada: [**Plaza Nueva**](https://www.google.com/maps/place/Plaza+Nueva,+Granada) y [**Calle Navas**](https://www.google.com/maps/place/Calle+Navas,+Granada).

> 🍺 **Tradición granadina:** en Granada la tapa es GRATIS con cada bebida. Se pide una caña o un vino y viene acompañada de una tapa que va creciendo en tamaño con cada ronda. A las 16:20 los bares están tranquilos — momento ideal para disfrutar sin cola.

| Sugerencia | Tipo | Nota |
|------------|------|------|
| [**Bodegas Castañeda**](https://www.google.com/maps/search/Bodegas+Castañeda+Granada) | Bodega clásica desde 1936 | Vermut de barril, montaditos, croquetas. Ambiente auténtico |
| [**Bar Poë**](https://www.google.com/maps/search/Bar+Poë+Granada) | Tapas generosas gratis | Muy popular entre locales, tapas grandes con cada bebida |
| [**Los Diamantes**](https://www.google.com/maps/search/Los+Diamantes+Granada+Calle+Navas) | Fritura granadina | ⚠️ Especialidad en pescaíto frito (Pasajero 2: pedir croquetas, tortilla, jamón) |
| [**La Cueva de 1900**](https://www.google.com/maps/search/La+Cueva+de+1900+Granada) | Cueva-restaurante | Ambiente de cueva, cocina granadina tradicional |

> 🎯 **Recomendación:** [**Bodegas Castañeda**](https://www.google.com/maps/search/Bodegas+Castañeda+Granada) — icónica bodega granadina. Pedir el vermut de barril y dejarse llevar por las tapas. Si hay cola, ir a **Bar Poë** que está muy cerca.
...
| Detalle | Info |
|---------|------|
| **Qué es** | Mausoleo de los Reyes Católicos (Isabel I y Fernando II), Juana la Loca y Felipe el Hermoso. Estilo gótico isabelino (1505-1517) |
...
- **Sepulcros reales** — tumbas de mármol de Carrara de Isabel, Fernando, Juana y Felipe. Las esculturas de Domenico Fancelli (1517) son obras maestras del Renacimiento
- **Cripta** — debajo de los sepulcros, con los sencillos ataúdes de plomo originales
- **Retablo Mayor** — retablo gótico-renacentista de Felipe Bigarny (1520)
- **Sacristía-Museo** — colección de arte de la reina Isabel: pinturas flamencas de **Roger van der Weyden**, **Memling**, **Botticelli**, **Perugino**. La corona y el cetro de Isabel. La espada de Fernando
- **Reja de Bartolomé de Jaén** — impresionante reja de forja dorada que separa la capilla

> 💡 *La sacristía-museo es tan valiosa como muchos museos europeos. La colección de pintura flamenca de Isabel la Católica es extraordinaria. No se permite fotografiar dentro.*
...
> 💡 *El minibús C2 sube desde Plaza Nueva hasta el Sacromonte. Sale cada 8-10 min. Si se prefiere taxi, hay parada en Plaza Nueva (~3 min caminando desde la Capilla Real).*
...
| Detalle | Info |
|---------|------|
| **Qué es** | Museo etnográfico en 11 cuevas originales del barrio del Sacromonte. Muestra la forma de vida tradicional gitana y las actividades artesanales (fragua, cerámica, tejido) |
| **Horario (sept)** | 10:00–20:00 (último acceso 19:30) |
| **Duración** | ~45 min |
...
- **11 cuevas amuebladas** — recrean la vida doméstica y artesanal de los habitantes del Sacromonte
- **Talleres** — fragua gitana, taller de cerámica, de tejido
- **Vistas** — desde las cuevas hay vistas espectaculares a la Alhambra y al Albaicín
- **Sendero botánico** — recorrido entre las cuevas con vegetación mediterránea

> 💡 *El Sacromonte es el barrio gitano de Granada, famoso por sus cuevas excavadas en la montaña de arcilla blanca y por ser cuna del flamenco granadino. Las cuevas son frescas por dentro incluso en verano (~18°C constante).*
...
| Detalle | Info |
|---------|------|
| **Qué es** | Antiguo barrio árabe, el más antiguo de Granada. Callejuelas empedradas, cármenes (casas con jardín), plazas escondidas, aljibes y vistas a la Alhambra |
| **Precio** | Gratis (paseo libre) |
| **Duración** | ~30 min |

#### Ruta directa (~30 min)

1. **Camino del Sacromonte** — bajar por el camino que conecta el Sacromonte con el Albaicín. Vistas a las cuevas blancas y a la Alhambra
2. **[Plaza Larga](https://www.google.com/maps/search/Plaza+Larga+Albaicín+Granada)** — mercadillo local, arco árabe del siglo XI, ambiente de barrio
3. **Callejón de las Tomasas** — callejuela con vistas a la Alhambra entre muros blancos
4. **[Mirador de San Nicolás](https://www.google.com/maps/place/Mirador+de+San+Nicolás,+Granada)** — punto final del paseo (ver siguiente sección)

> 💡 *El Albaicín se disfruta perdiéndose. La ruta directa pasa por los puntos más carismáticos en 30 min, justo a tiempo para el atardecer en San Nicolás. Calzado cómodo imprescindible (empedrado irregular).*
...
| Detalle | Info |
|---------|------|
| **Qué es** | Mirador con la vista más famosa de la Alhambra: el palacio iluminado por el atardecer con Sierra Nevada de fondo. Bill Clinton lo declaró "el atardecer más bello del mundo" |
| **Precio** | Gratis |
| **Atardecer** | ~20:00–20:15 en septiembre |
| **Duración** | ~25 min |
...
### 🍵 20:10 — Tetería en Calle Calderería Nueva (opcional, 15 min)

📍 [**Calle Calderería Nueva**](https://www.google.com/maps/place/Calle+Calderería+Nueva,+Granada) — la "calle de las teterías", a 10 min caminando del Mirador de San Nicolás, bajando hacia Plaza Nueva.

| Detalle | Info |
|---------|------|
| **Qué es** | Calle estrecha llena de teterías árabes, tiendas de artesanía marroquí, lámparas y especias. Ambiente del zoco |
| **Sugerencia** | Un té moruno con dulces árabes (~€5-7/pax) como cierre antes de partir |

> 💡 *Parada breve y opcional. Si el tiempo apremia, ir directamente a Plaza Nueva para el taxi de vuelta al parking.*
...
#### Opción 1 (recomendada): Parking zona Paseo de Blas Infante / Alameda del Tajo

📍 [**Paseo de Blas Infante**](https://www.google.com/maps/search/Paseo+de+Blas+Infante+Ronda) — aparcamiento en superficie junto a la Alameda del Tajo.

| Detalle | Info |
|---------|------|
| **Tipo** | Plazas en superficie (zona azul + algunas libres) |
| **Precio** | Zona azul: ~€0,70/hora (máx 2h). Plazas libres en calles adyacentes: gratis |
| **Distancia** | A 2-3 min a pie de la Plaza de Toros y 5 min del Puente Nuevo |
| **Ventaja** | La ubicación más céntrica y conveniente |

#### Opción 2: Parking subterráneo Martínez Astein

📍 [**Parking Martínez Astein**](https://www.google.com/maps/search/Parking+Martínez+Astein+Ronda) — parking cubierto cerca de la Plaza del Socorro.

| Detalle | Info |
|---------|------|
| **Tipo** | Parking subterráneo, cubierto y vigilado |
| **Precio** | ~€1,50-2/hora |
| **Distancia** | A 3-5 min a pie del Puente Nuevo y Plaza de Toros |
| **Ventaja** | Cubierto, seguro, sin límite de tiempo |

#### Opción 3 (gratuita): Zona Polideportivo El Fuerte

📍 [**Polideportivo El Fuerte**](https://www.google.com/maps/search/Polideportivo+El+Fuerte+Ronda) — aparcamiento libre al sureste del centro.

| Detalle | Info |
|---------|------|
| **Tipo** | Aparcamiento libre al aire libre, gran capacidad |
| **Precio** | **Gratis** ✅ |
| **Distancia** | ~10 min a pie hasta el Puente Nuevo |
| **Ventaja** | Siempre hay sitio, ideal si las otras opciones están llenas (domingo) |
...
| Detalle | Info |
|---------|------|
| **Qué es** | Una de las plazas de toros más antiguas y bellas de España (1785). Estilo neoclásico con doble arcada de piedra |
| **Horario (sept)** | 10:00-20:00 |
| **Precio** | ~€8/pax (incluye museo taurino) |
| **Duración** | ~30-45 min |

> 💡 *Aunque no seas aficionado a la tauromaquia, la arquitectura de la plaza es impresionante. El museo incluye trajes de luces históricos y carteles originales.*
...
| Detalle | Info |
|---------|------|
| **Qué es** | Puente de piedra de 98 m de altura sobre el Tajo de Ronda (siglo XVIII). Conecta la ciudad nueva con el casco antiguo |
| **Precio** | Gratis (cruzar el puente). Centro de interpretación: ~€2,50/pax |
| **Duración** | ~1h (con miradores) |

#### Qué ver

- **Cruzar el puente** y admirar las vistas al desfiladero
- [**Mirador de Aldehuela**](https://www.google.com/maps/search/Mirador+de+Aldehuela+Ronda) — el mejor punto para fotografiar el puente desde abajo (acceso por escaleras junto al Parador)
...
### 🍽️ ~21:15 — Cena especial en Málaga — última noche (1h 30min)

> 🚫🦐 *Recordar: Pasajero 2 no come frutos del mar.*

Última cena en Málaga. Opciones cerca del hotel:

| Restaurante | Tipo | Precio aprox. | Nota |
|-------------|------|---------------|------|
| [**Kaleja**](https://www.google.com/maps/search/Kaleja+restaurante+Málaga) | ⭐ Michelin, cocina malagueña moderna | €60-80/pax | Reservar con antelación. Platos de carne excelentes |
| [**El Mesón de Cervantes**](https://www.google.com/maps/search/El+Mesón+de+Cervantes+Málaga) | Tapas creativas | €30-45/pax | Ambiente íntimo, buena carta |
| [**Uvedoble Taberna**](https://www.google.com/maps/search/Uvedoble+Taberna+Málaga) | Tapas y raciones | €25-35/pax | Cocina andaluza moderna |
